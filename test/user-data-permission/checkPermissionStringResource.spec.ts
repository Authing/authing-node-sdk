...
import { CheckPermissionStringResourceDto } from "../../src/models";
...
describe("checkPermissionStringResource", () => {
  ...
  it("Check Permission String Resource Success", async () => {
    ...
    let checkPermissionStringResourceDto: CheckPermissionStringResourceDto = {
      resources: [str1ResourceCode, str2ResourceCode],
      action: "get",
    };
    const result = await checkAuthClient.checkPermissionByStringResource(
      checkPermissionStringResourceDto
    );
