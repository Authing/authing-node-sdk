 ...
 */
public async resetFactor(requestBody: RestFactorDto,
                                     ...
                                     * {
                                         ...
                                         * {
                                             ...
                                             * {
                                                 ...
                                                 */
                                                public async unbindExtIdp(requestBody: UnbindExtIdpDto,
                                             ...
                                             * [
                                                 ...
                                                 * @returns any
                                                 */
                                                public async getWechatMiniprogramPhone(requestBody: GetWechatMiniProgramPhoneDto,
                                            ): Promise<any> {
                                                const result = await this.httpClient.request({
                                                    method: 'POST',
                                         ...
                                         */
                                        public async upload(requestBody: UploadDto,
                                    ): Promise<UploadRespDto> {
                                        const result = await this.httpClient.request({
                                            method: 'POST',
                                            url: '/api/v2/upload',
                                            data: requestBody,
 ...
 */
public async verifyUpdateEmailRequest(requestBody: UpdateEmailVerifyRequestDto,
 ...
 */
public async veirfyDeleteAccountRequest(requestBody: VerifyDeleteAccountRequestDto,
