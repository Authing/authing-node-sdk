 ...
 * @returns IsSuccessRespDto
 */
public async changeAssociationState(requestBody: AssociationExtIdpDto,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns IsSuccessRespDto
 */
public async associationResources(requestBody: AssociationResourceDto,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns IsSuccessRespDto
 */
public async authorizeApplicationAccess(requestBody: AddApplicationPermissionRecord,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns IsSuccessRespDto
 */
public async revokeApplicationAccess(requestBody: DeleteApplicationPermissionRecord,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
